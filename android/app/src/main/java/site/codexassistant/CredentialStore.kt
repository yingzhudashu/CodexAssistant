...
class CredentialStore(context: Context) {
    ...
    private val preferences =
        context.getSharedPreferences("codex_credentials", Context.MODE_PRIVATE)
    ...
    fun saveConnection(value: String, token: String) {
        ...
        val uri =
            try {
                ...
                throw IllegalArgumentException("服务地址无效")
            }
        ...
        require(
            ...
            "请输入 HTTPS 根地址，禁止路径、查询参数或用户信息；HTTP 仅限回环地址"
        }
        val cipher =
    ...
    fun apiUrl(): String =
        preferences.getString("apiUrl", BuildConfig.CODEX_BASE_URL) ?: BuildConfig.CODEX_BASE_URL
