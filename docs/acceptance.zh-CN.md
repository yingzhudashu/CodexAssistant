...
服务端于2026-09-13部署 release `20260913013050-437c91cf7458`，现有schema6数据保留，服务及公网health通过。配置回滚备份在 `/var/backups/codex-assistant/20260913013050-437c91cf7458`。下载清单备份在 `/var/backups/codex-assistant/20260913-desktop-host`。
