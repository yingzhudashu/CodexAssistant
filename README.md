...
- [Windows 安装包](https://robotclaw.site/codex-assistant/downloads/CodexAssistant-2.0.10.exe)（未签名）
- [Android APK](https://robotclaw.site/codex-assistant/downloads/CodexAssistant-2.0.8.apk)（release keystore 签名）
