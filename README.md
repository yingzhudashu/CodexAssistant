...
- [Windows 安装包](https://robotclaw.site/codex-assistant/downloads/CodexAssistant-2.0.14.exe)（未签名）
- [Android APK](https://robotclaw.site/codex-assistant/downloads/CodexAssistant-2.0.13.apk)（release 签名）
